...
## Completed
- **2026-08-25 — CURSOR-BUGBOT — COMPLETED — Android employee photo protect.**  `MatchPipeline` skipped people only when they had a photo and a blank org, so "Maya Chen" at Apple auto-approved HIGH and `applyPhoto` deleted the personal photo with no undo.  Employees are now SKIP; existing business photos stay review-only.  Did not touch DNS or the domain-link claim.
