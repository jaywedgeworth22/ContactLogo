...
object SimpleIcons {
    ...
    private val slugs: Map<String, String> = mapOf(
        "apple.com" to "apple", "google.com" to "google",
        "meta.com" to "meta", "facebook.com" to "facebook",
        "instagram.com" to "instagram", "tesla.com" to "tesla",
        "nvidia.com" to "nvidia", "netflix.com" to "netflix",
        "spotify.com" to "spotify", "intel.com" to "intel",
        "cisco.com" to "cisco", "stripe.com" to "stripe",
        ...
        "ups.com" to "ups", "usps.com" to "usps",
        "target.com" to "target", "starbucks.com" to "starbucks",
        "mcdonalds.com" to "mcdonalds", "uber.com" to "uber",
        "lyft.com" to "lyft", "doordash.com" to "doordash",
        "airbnb.com" to "airbnb", "nike.com" to "nike",
        "samsung.com" to "samsung", "sony.com" to "sony",
        "ford.com" to "ford", "bmw.com" to "bmw",
        "x.ai" to "x", "x.com" to "x",
        "twitter.com" to "x", "github.com" to "github",
        "youtube.com" to "youtube", "discord.com" to "discord",
        "zoom.us" to "zoom", "notion.so" to "notion",
        ...
        "telegram.org" to "telegram", "signal.org" to "signal",
        "ebay.com" to "ebay", "shopify.com" to "shopify",
        "spacex.com" to "spacex", "starlink.com" to "spacex",
        "squareup.com" to "square"
    )
